<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="instructorhome.aspx.cs" Inherits="STUD.instructorhome" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#94C13E" Text="Student Managment System"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="#378D95"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;<asp:Button ID="Button13" runat="server" BackColor="White" BorderStyle="None" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Small" ForeColor="#378D95" Height="19px" OnClick="Button13_Click" Text="View Placment Info" Width="156px" />
        </p>
        <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="#94C13E" Text="."></asp:Label>
            &nbsp;<asp:Button ID="Button25" runat="server" BackColor="White" BorderStyle="None" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Small" ForeColor="#378D95" Height="19px" OnClick="Button25_Click" Text="Add Result " Width="156px" />
        </p>
        <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;
        <asp:Button ID="instructor" runat="server" BackColor="White" BorderStyle="None" Font-Bold="True" Font-Names="Book Antiqua" Font-Size="Small" ForeColor="#378D95" Height="19px" OnClick="instructor_Click" Text="Withdrawal" Width="156px" />
        </p>
        <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div>
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="902px">
